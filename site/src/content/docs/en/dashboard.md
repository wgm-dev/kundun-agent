---
title: Web Dashboard
description: The Kundun Control Center is a small web UI for the local daemon — static HTML, CSS, and vanilla JavaScript bundled with the package and served by the local HTTP API.
---
