---
title: Architecture
description: How Kundun-Agent is put together — the layered module structure, the single composition root, the SQLite storage model, and the on-disk layout under .kundun/.
---
...
"how do I add a CLI command?") see [`../../CLAUDE.md`](https://github.com/wgm-dev/kundun-agent/blob/main/CLAUDE.md).
...
- [Search](/en/search/) — how the FTS5 / LIKE providers are chosen and used
