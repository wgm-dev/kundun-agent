---
title: Configuration
description: Kundun-Agent is configured through a single file, kundun.config.json, at the root of your project. This page documents every key, its default value, and its meaning.
---
...
[Security](/en/security/) and [Scanner & indexing](/en/scanner-indexing/)).
...
run cleanup explicitly with `kundun cleanup`; see [Cleanup](/en/cleanup/).
...
See [Cleanup](/en/cleanup/) for the full behavior, including what a dry run does
and does not change.
...
- [Scanner & indexing](/en/scanner-indexing/)
