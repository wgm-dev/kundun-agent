---
title: Search
description: Kundun-Agent indexes your codebase into searchable chunks so you (or an AI agent) can find relevant code by keyword without scanning the whole repository.
---
...
[Scanner & indexing](/en/scanner-indexing/) for how chunks are produced.
...
> not indexed. See [Scanner & indexing](/en/scanner-indexing/).
...
[CLI reference](/en/cli-reference/) for full details.

## See also

- [Documentation hub](/en/)
- [Scanner & indexing](/en/scanner-indexing/) — how files become searchable chunks
- [CLI reference](/en/cli-reference/) — full command and flag reference
