---
title: Task Engine
description: The task engine is Kundun-Agent's lightweight, local-first work tracker for recording what needs doing, picking the next task, and linking work to code and decisions.
---
...
indexed codebase and to entries in the [memory engine](/en/memory-engine/).
...
All commands share the [global CLI options](/en/cli-reference/) — notably
...
[memory engine](/en/memory-engine/). These relations are stored as JSON on the task,
...
the [memory engine](/en/memory-engine/) page for how memories are created and
classified.

## See also

- [Documentation hub](/en/)
- [Memory engine](/en/memory-engine/) — persistent project memory you can relate
  tasks to.
- [CLI reference](/en/cli-reference/) — full list of commands and global options.
