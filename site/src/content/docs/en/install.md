---
title: Installation & MCP client setup
description: Install Kundun-Agent and register it as an MCP server in Claude Code, Codex, and the Gemini CLI.
---
...
each one does in the [MCP integration](/en/mcp-integration/) guide.
...
- [MCP integration (the 18 tools)](/en/mcp-integration/)
