---
title: Arquitetura
description: Esta página descreve a arquitetura interna do Kundun-Agent em alto nível, as camadas de código, a raiz de composição e o modelo de armazenamento em SQLite.
---
...
[`CLAUDE.md`](https://github.com/wgm-dev/kundun-agent/blob/main/CLAUDE.md) na raiz do repositório.
...
- [Visão geral da documentação](/pt-br/)
- [Configuração](/pt-br/configuration/) — todas as chaves do `kundun.config.json`.
- [Scanner e indexação](/pt-br/scanner-indexing/) — como `files`, `file_chunks` e `symbols`
  são preenchidos.
