...
description: O motor de memória é a camada de memória persistente de projeto do Kundun-Agent, guardando conhecimento sobre o seu projeto localmente em SQLite.
---
...
- [Motor de tarefas](/pt-br/task-engine/) — tarefas podem se relacionar a memórias.
- [Limpeza](/pt-br/cleanup/) — retenção e remoção automática de memórias.
