...
description: O motor de tarefas do Kundun-Agent mantém uma lista de trabalho persistente do projeto, armazenada localmente no SQLite.
---
...
- [Voltar ao índice da documentação](/pt-br/)
