...
description: Lista autoritativa de comandos do Kundun-Agent no MVP 1, com argumentos, flags exatos, exemplos de invocação e observações sobre as opções globais.
---
