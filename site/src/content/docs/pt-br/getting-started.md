...
description: O Kundun-Agent é uma camada de inteligência de projeto local-first para agentes de programação. Esta página leva você do zero ao primeiro uso.
---
...
[Dashboard web](/pt-br/dashboard/) para mais detalhes.

## Próximos passos

- Ajuste o que é indexado e a retenção em [Configuração](/pt-br/configuration/).
- Veja todos os comandos e flags na [Referência da CLI](/pt-br/cli-reference/).
- Entenda como os arquivos viram chunks e símbolos em
  [Scanner e indexação](/pt-br/scanner-indexing/).
- Aprofunde-se em busca e memória em [Busca](/pt-br/search/) e
  [Motor de memória](/pt-br/memory-engine/).

## Veja também

- [Documentação do Kundun-Agent (hub)](/pt-br/)
- [Referência da CLI](/pt-br/cli-reference/)
