...
indexado (veja [Scanner e indexação](scanner-indexing.md)).
...
- [Scanner e indexação](scanner-indexing.md) — como os arquivos são escaneados e divididos
  nos chunks que a busca consulta.
- [Referência da CLI](cli-reference.md) — todos os comandos e flags.
- Hub da documentação: [`../README.md`](../README.md)
