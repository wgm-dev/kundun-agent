...
forma privada, consulte [`SECURITY.md`](../../SECURITY.md).

## Veja também

- [README da documentação](../README.md) — índice de todas as páginas.
- [Scanner e indexação](scanner-indexing.md) — motivos de skip, detecção por
  hash e tratamento de arquivos sensíveis em detalhe.
- [Configuração](configuration.md) — chaves `include`, `exclude`,
