...
All commands accept the [global options](../README.md) (`--project-root`,
...
**never** removed by automatic [cleanup](cleanup.md). Cleanup only ever
...
[configuration](configuration.md). High-importance memories (`>= 80`) are still
...
- [Cleanup](cleanup.md) — retention rules, and why high-importance memories
  survive.
- [Search](search.md) — how FTS5/LIKE search works across indexed content.
